...
int main()
{
    ...
    cppsock::tcp_server_setup(listener, nullptr, 10000, 1);                         check_errno("Error setting up TCP server");
    cppsock::tcp_client_connect(client, nullptr, 10000);                            check_errno("Error connecting to TCP server");
