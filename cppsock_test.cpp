...
int main()
{
    ...
    std::cout << "Test case 2: Simple TCP connection via loopback, port 10001" << std::endl;
    cppsock::tcp_server_setup(listener, nullptr, 10001, 2);                         check_errno("Error setting up TCP server");
    ...
    listener.close(); server.close(); client.close(); std::cout << std::endl;       errno = 0; //  no error checking for closing sockets since this can cause problems with windows

    std::cout << "Test case 3: Socket options" << std::endl;
    cppsock::tcp_server_setup(listener, nullptr, 10002, 2);                                                                                 check_errno("Error setting up TCP server");
    ...
    std::cout << "Test case 4: sending / recving data" << std::endl;
