...
gcc -c -o obj/cppsock_udp_socket.cpp.o cppsock_udp_socket.cpp
ar -r -s out/libcppsock.a obj/cppsock_addressinfo.cpp.o obj/cppsock_socket.cpp.o obj/cppsock_socketaddr.cpp.o obj/cppsock_utility.cpp.o^
 obj/cppsock_tcp_client.cpp.o obj/cppsock_tcp_listener.cpp.o obj/cppsock_tcp_socket.cpp.o obj/cppsock_udp_socket.cpp.o
